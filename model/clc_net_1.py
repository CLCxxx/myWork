...
class full_encoder(nn.Module):
    def __init__(self, in_channel=3):
        ...
        self.encoder_layer2 = full_encoder_level(in_channel=64, out_channel=128, eca_num=1)
        self.encoder_layer3 = full_encoder_level(in_channel=128, out_channel=256, eca_num=1)
...
class full_decoder(nn.Module):
    def __init__(self, in_channel=256):
        ...
        c = in_channel
        self.full_decoder_layer1 = full_decoder_level(in_channel=256, out_channel=128, eca_num=1)
        self.full_decoder_layer2 = full_decoder_level(in_channel=128, out_channel=64, eca_num=1)
...
class sub_encoder(nn.Module):
    def __init__(self):
        ...
        self.sub_encoder_layer2 = sub_encoder_level(in_channel=64, out_channel=128, spa_num=1)
        self.sub_encoder_layer3 = sub_encoder_level(in_channel=128, out_channel=256, spa_num=1)
...
class sub_decoder(nn.Module):
    def __init__(self, in_channel=256):
        ...
        c = in_channel
        self.sub_encoder_layer1 = sub_decoder_layer(in_channel=256, out_channel=128, spa_num=1)
        self.sub_encoder_layer2 = sub_decoder_layer(in_channel=128, out_channel=64, spa_num=1)
...
if __name__ == '__main__':
    ...
    print(layer(a, b)[0].size())
    print(layer(a, b)[1].size())
    print(layer(a, b)[2].size())
