...
class full_decoder(nn.Module):
    def __init__(self, in_channel=256, out_channel=32):
        ...
        self.full_decoder_layer3 = full_decoder_level(in_channel=64, out_channel=32, eca_num=0)
...
class sub_decoder(nn.Module):
    def __init__(self, in_channel=256):
        ...
        self.sub_decoder_layer3 = sub_decoder_layer(in_channel=64, out_channel=32, spa_num=0)
